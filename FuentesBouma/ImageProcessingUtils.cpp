 ...
 */
void ImageProcessingUtils::histogram (ImageType::Pointer image ,int lower, int upper) {
 ...
 * @param image : Imagen a la que se le va a calcular el histograma.
 */
void ImageProcessingUtils::histogram (ImageType::Pointer image) {
 ...
 * @param upper : Mayor valor de intensidad encontrado en la imagen que será el máximo valor en el histograma.
 */
void ImageProcessingUtils::histogram (ImageType::Pointer image,ImageBinaryType::Pointer mask ,int lower, int upper) {
 ...
 * @param mask : Imagen que contiene la máscara con la región de interés.
 */
void ImageProcessingUtils::histogram (ImageType::Pointer image,ImageBinaryType::Pointer mask) {
